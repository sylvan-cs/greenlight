    ...
    <div className="min-h-screen bg-background text-foreground px-6 py-12">
      <div className="max-w-[640px] mx-auto">
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-muted-foreground">
          <section>
            <h2 className="text-foreground font-semibold text-lg mb-3">1. What We Collect</h2>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-lg mb-3">2. How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-lg mb-3">3. SMS Communications</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-lg mb-3">4. Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-lg mb-3">5. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-lg mb-3">7. Contact</h2>
            <p>
