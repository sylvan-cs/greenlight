    ...
    <div className="min-h-screen bg-dark-bg text-white px-6 py-12">
      <div className="max-w-[640px] mx-auto">
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-gray-300">
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">1. About The Starter</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">4. The Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">5. SMS &amp; Notifications</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-semibold text-lg mb-3">6. Changes to the Service</h2>
            <p>
